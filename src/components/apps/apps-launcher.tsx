...
const APPS: AppCard[] = [
  ...
  },
  {
    href: "/pos",
    title: "Point of Sale",
    description: "Retail till — barcode scan, split payments, end-of-day reconciliation.",
    icon: Store,
    gradient: "from-lime-500 to-green-600",
    glow: "shadow-lime-500/30",
    category: "Operations",
    keywords: ["till", "cashier", "retail", "counter"],
    roles: ["super_admin", "tenant_admin", "sales", "viewer"],
  },
  {
    href: "/manufacturing",
    title: "Manufacturing",
    description: "Bill of materials and work orders for the shop floor.",
    icon: Factory,
    gradient: "from-orange-500 to-red-600",
    glow: "shadow-orange-500/30",
    category: "Operations",
    keywords: ["bom", "work order", "production", "shop floor"],
    roles: ["super_admin", "tenant_admin", "warehouse", "viewer"],
  },
  {
    href: "/projects",
    title: "Projects & Timesheets",
    description: "Track billable work, budgets and time against projects.",
    icon: FolderKanban,
    gradient: "from-teal-500 to-cyan-600",
    glow: "shadow-teal-500/30",
    category: "Operations",
    keywords: ["projects", "timesheets", "billable", "tasks"],
    roles: ["super_admin", "tenant_admin", "sales", "hr", "accountant", "viewer"],
  },
  {
    href: "/attendance",
    title: "Attendance",
    description: "Clock in/out with geolocation and source tracking.",
    icon: Clock,
    gradient: "from-purple-500 to-indigo-600",
    glow: "shadow-purple-500/30",
    category: "People",
    keywords: ["clock in", "clock out", "attendance", "hours", "timekeeping"],
    roles: ["super_admin", "tenant_admin", "hr", "viewer"],
  },
  {
    href: "/recurring-invoices",
    title: "Recurring Invoices",
    description: "Subscriptions, retainers and monthly rent — automated.",
    icon: Repeat,
    gradient: "from-pink-500 to-rose-600",
    glow: "shadow-pink-500/30",
    category: "Finance",
    keywords: ["subscription", "retainer", "rent", "auto"],
    roles: ["super_admin", "tenant_admin", "accountant", "sales", "viewer"],
  },
  {
    href: "/approvals",
    title: "Approvals",
    description: "Review and decide on expense, PO, journal and leave requests.",
    icon: ClipboardCheck,
    gradient: "from-yellow-500 to-amber-600",
    glow: "shadow-yellow-500/30",
    category: "Admin",
    keywords: ["approve", "reject", "workflow", "review"],
    roles: ["super_admin", "tenant_admin", "accountant", "hr", "purchasing"],
  },
  {
    href: "/audit-log",
    title: "Audit Log",
    description: "Immutable log of every action taken across the platform.",
    icon: ScrollText,
