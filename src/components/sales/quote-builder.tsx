    ...
    <div className="mx-auto max-w-5xl space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h2 className="text-lg font-semibold text-slate-900 leading-tight">New Quotation</h2>
            <p className="text-xs text-slate-500 leading-tight">Create a quotation and convert to invoice when accepted</p>
          </div>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <Card className="overflow-hidden border-0 shadow-sm ring-1 ring-slate-200">
            ...
            <CardContent className="space-y-4 p-5">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="space-y-1.5">
                  <Label className="text-slate-700">Valid Until <span className="text-red-500">*</span></Label>
                  <Input type="date" {...register("expiry_date")} className={errors.expiry_date ? "border-red-400" : "border-slate-200"} />
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="overflow-hidden border-0 shadow-sm ring-1 ring-slate-200">
            ...
            <CardContent className="space-y-4 p-5">
              <div className="space-y-1.5">
                ...
                <Textarea placeholder="Thank you for your inquiry…" rows={2} {...register("notes")} className="border-slate-200 resize-none" />
              </div>
              <div className="space-y-1.5">
                <Label className="text-slate-700">Terms &amp; Conditions</Label>
                <Textarea placeholder="Prices valid for 14 days…" rows={2} {...register("terms")} className="border-slate-200 resize-none" />
              </div>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="flex gap-3 justify-end pb-4">
          <Button type="button" variant="outline" asChild className="border-slate-200 text-slate-600 hover:bg-slate-50">
            <Link href="/sales?tab=quotes">Cancel</Link>
          </Button>
          <Controller
            control={control}
            name="status"
